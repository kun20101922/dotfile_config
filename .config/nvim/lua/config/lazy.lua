...
require("lazy").setup({
  spec = {
    ...
    { import = "lazyvim.plugins.extras.editor.neo-tree" }, -- neo-tree
    { import = "lazyvim.plugins.extras.editor.mini-move" }, -- mini-move
    { import = "lazyvim.plugins.extras.editor.outline" }, -- outline

    -- coding
    { import = "lazyvim.plugins.extras.coding.nvim-cmp" }, -- nvim-cmp
    { import = "lazyvim.plugins.extras.coding.luasnip" }, -- luasnip
    { import = "lazyvim.plugins.extras.coding.mini-comment" }, -- mini-comment
    ...
    -- { import = "lazyvim.plugins.extras.vscode" } -- vscode
